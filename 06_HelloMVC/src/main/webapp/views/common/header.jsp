		...
		<header>
					...
					<table>
						...
						<tr>
							<td><label for="saveId"><input type="checkbox"
									name="saveId" id="saveId" <%=saveId != null ? "checked" : ""%>>
									아이디저장</label><input type="button" value="회원가입"
			...
			<nav>
				<ul class="main-nav">
					...
					%>
					<!-- 처음부터 로그인상태가 아닐때도 처리해야함 -> !=null -->
					<li id="member"><a
						href="<%=request.getContextPath()%>/admin/memberList.do">회원관리</a></li>
					<%
					}
					%>
				</ul>
